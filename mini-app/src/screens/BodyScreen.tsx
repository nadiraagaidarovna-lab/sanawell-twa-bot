...
export default function BodyScreen() {
  return (
    <main className="screen v2-screen v2-accent-body">
      ...
      {BODY_SECTIONS.map((section) => (
        <details className="ex-section" key={section.title}>
          ...
          <div className="ex-section-content">
            ...
            <div className="ex-items">
              {section.items.map((item) =>
                hasBody(item) ? (
                  <details className="ex-item" key={item.title}>
                  ...
                  <div className="ex-item-static" key={item.title}>
                    {item.title}
                  </div>
                )
              )}
